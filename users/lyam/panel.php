        ...
        <section class="Apps">
            ...
            <article>
                ...
                <article>
                    ...
                    <div class="navigation_quiz" style="display: none;">
                        <h1>Navigation rapide : </h1>
                        <ul>
                            <li>LWPS :
                                <ul>
                                    <li><button onclick="window.location = './CLOUD/apps/lquiz/admin/index.php';">ADMIN
                                            (Ajouter
                                            des questions)</button></li>
                                    <li><button onclick="window.location = './CLOUD/apps/lquiz/admin/index.html';">ADMIN
                                            (voire
                                            la progression des joueurs)</button>
                                    </li>
                                </ul>
                            </li>
                        </ul>
