<?php
include("C:/hacking/www/auto.php");
    ...
    <main>
        ...
        <ul>
            ...
            <li><span class="current"></span><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                    fill="#106EBE" class="bi bi-filetype-html" viewBox="0 0 16 16">
                    <path fill-rule="evenodd"
                ...
                </svg><strong>Site Web</strong></li>
            <li><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-eye"
                    viewBox="0 0 16 16">
                    <path
                        d="M16 8s-3-5.5-8-5.5S0 8 0 8s3 5.5 8 5.5S16 8 16 8zM1.173 8a13.133 13.133 0 0 1 1.66-2.043C4.12 4.668 5.88 3.5 8 3.5c2.12 0 3.879 1.168 5.168 2.457A13.133 13.133 0 0 1 14.828 8c-.058.087-.122.183-.195.288-.335.48-.83 1.12-1.465 1.755C11.879 11.332 10.119 12.5 8 12.5c-2.12 0-3.879-1.168-5.168-2.457A13.134 13.134 0 0 1 1.172 8z" />
                    <path d="M8 5.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5zM4.5 8a3.5 3.5 0 1 1 7 0 3.5 3.5 0 0 1-7 0z" />
                </svg><a href="./view.php" style="color: black; text-decoration: none;">Apercu</a></li>
        </ul>
        <div class="menu">
...
{
    echo "<script>const InnerFolder = '".str_replace("./CLOUD/_", "", $Rep)."'</script>";
...
<a style=" cursor: pointer;" href="./website.php?folder='.str_replace("//", "/",$Rep."/".$Dossier).'/">
...
<div class="menu">
    ...
    <div class="content" style="display: none;">
        <ul>
            <li class="FILE_ACTION_RENAME" data-from="'.str_replace("./CLOUD/_", "", $Rep . "/". $Dossier).'">Renommer</li>
            <li class="FILE_ACTION_DELETE" data-from="'.str_replace("./CLOUD/_", "", $Rep . "/". $Dossier).'">Supprimer</li>
            <li>Détails</li>
        </ul>
    </div>
</div>
            ...
            if ($Dossier !== "fileAction.php" && pathinfo($Dossier, PATHINFO_EXTENSION) === "html") {
            ...
            <h3><a style="color: black; text-decoration: none;" href="edit.php?file='.$Rep."/".$Dossier.'">'.$Dossier.'</a></h3>
            <div class="menu">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    class="bi bi-three-dots-vertical" viewBox="0 0 16 16">
                    <path
...
read_dir("./CLOUD/_");
        ...
        $(".ion-location").click(function() {
            const folder_name = prompt(
                "Nom du fichier (pour la page d’accueil du site/dossier mettez index)", InnerFolder +
                "index");
            const XML = new XMLHttpRequest();
        ...
        document.querySelectorAll(".FILE_ACTION_RENAME").forEach(element => {
            element.addEventListener("click", () => {
                ...
                XML.open("GET", "./CLOUD/fileAction.php?action=rename&val_1=" + element.dataset.from +
                    "&val_2=" + prompt("Nouvelle Value", InnerFolder).split(
                        ".")[element
                        .dataset.from.split(".").length - 1])
                XML.responseType = "text";
                XML.onload = function() {
                    location.reload();
                }
